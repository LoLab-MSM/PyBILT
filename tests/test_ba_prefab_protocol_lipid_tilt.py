...
from pybilt.bilayer_analyzer.prefab_analysis_protocols import lipid_tilt


def test_analysis_module_lipid_tilt():
    ...
    ref_atoms = {'DOPE':{'start':['C218','C318'], 'end':'P'},
                 ...
                 'TLCL2':{'start':['CA18','CB18','CC18', 'CD18'],
                          'end':['P1', 'P3']}}
    lipid_tilt(structure_file='../pybilt/sample_bilayer/sample_bilayer.psf',
...
if __name__ == '__main__':
    test_analysis_module_lipid_tilt()
