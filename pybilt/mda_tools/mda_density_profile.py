...
#                Pages 2484-2494, ISSN 0006-3495, http://dx.doi.org/10.1016/S0006-3495(01)75894-8.
#                (http://www.sciencedirect.com/science/article/pii/S0006349501758948)
def partial_charge_density_profile(trajectory,mda_selection, fstart=0,fend=-1,fstep=1, axis='z',nbins=100,reference=0.0,refsel=None,valence=True):
    lat_ind = [0,1]
    dir_ind = 2
    ec_dict = valence_dict
    if not valence:
